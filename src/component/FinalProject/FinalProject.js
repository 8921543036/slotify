...
import Profile from "./Profile"; // your profile dropdown component
...
const goToCreateEvent = () => {
  if (isLoggedIn) {
    ...
    setShowStudentLogin(true); // open login popup
  }
};
      ...
      <div className="app-container">
        ...
        <section className="hero">
          <div className="hero__content">
            ...
            <p className="hero__subtitle">Turn your dream events into reality today.</p>
            <p className="hero__description">
              Enjoy the ease of discovering unique spaces, checking availability, and
              securing your date instantly.
            </p><br></br><br></br>
        ...
        {/* ---------------- WHAT WE DO SECTION ---------------- */}
        <section className="what-we-do" ref={aboutRef}>
          <h2 className="what-we-do__title">What Will Do?</h2>
          <p className="what-we-do__description">
            We offer a user-friendly platform that simplifies booking venues within the college
            for events, meetings, and workshops.
            <br />
            Students and staff can explore available spaces, check real-time availability,
            make reservations instantly, and manage all bookings from a single dashboard.
            {showMoreAbout && (
              <>
                <br />
                Designed to save time and reduce confusion, the system ensures smooth
                coordination and improved event organization with features like notifications,
                calendar sync, and easy cancellation management.
              </>
            )}
          </p>
        ...
        {/* ---------------- BOOK VENUE SECTION ---------------- */}
        <section className="book-venue" ref={bookVenueRef}>
          <h2 className="book-venue__title">Book Venue</h2>
          <div className="book-venue__cards">
            {/* ---- Create Event Card ---- */}
            <div
              className="venue-card venue-card--blue"
              onClick={goToCreateEvent} // ← Add navigation here
              style={{ cursor: "pointer" }}
            >
...
<div
  className="venue-card venue-card--white"
  onClick={goToPendingEvents}
  style={{ cursor: "pointer" }}
>
  ...
  <div className="venue-card__footer">
    ...
    <span className="venue-card__icon">
      <img src={Arrow} alt="arrow" />
            ...
            <div className="venue-card venue-card--white">
              <h3 className="venue-card__title">Calendar view</h3>
              <p className="venue-card__subtitle">
                Create and submit a new event request with complete venue and schedule details.
              </p>
              <div className="venue-card__footer">
                <span className="venue-card__action">view</span>
                <span className="venue-card__icon">
            ...
            <div className="contact-form-wrapper">
              ...
              <form className="contact-form">
                ...
                <div className="form-group">
                  ...
                  <textarea id="messages" rows="6" placeholder="Messages"></textarea>
                </div>
            ...
            <div className="contact-info-column">
              <div className="info-card info-card--blue">
                ...
                <p className="info-card__details">
                  ...
                  Kuttipuram, Malappuram, Kerala - 679573
                </p>
              </div>
